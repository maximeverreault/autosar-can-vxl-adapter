...
#define XL_MOST150_ECL_SEQ_DURATION_MIN                  1      // -> 100 �s
...
#define XL_MOST150_ECL_GLITCH_FILTER_MIN                 50      // -> 50 �s
 ...
 *  \param  pEclStatesDuration        [IN] Pointer to a buffer containing the ECL sequence states duration in multiple of 100 �s (max. value XL_MOST150_ECL_SEQ_DURATION_MAX)
 ...
 *  \param  XLuserHandle userHandle:  [IN] used to match the response of the driver to the requests of the application
 *                                         if an event is received spontaneously
 *  \param  duration                  [IN] Duration (in �s) of glitches to be filtered. Value range: 50 �s .. 50 ms (Default: 1 ms)
 *  \return XLstatus                       general status information
 */
